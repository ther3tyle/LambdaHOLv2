...
public class A_Lambdas {
    ...
    public void a_predicate4() {
        ...
        Predicate<String> startsWithJAndLengthIs7 = s -> startsWithJ.and(lengthIs7).test(s);
    ...
    public void a_predicate5() {
        ...
        Predicate<String> lengthIs9orError = s -> lengthIs9.or(equalsError).test(s);
    ...
    public void c_consumer4() {
        ...
        Consumer<List<String>> consumer = s -> c1.andThen(c2).accept(s);
